...
;// CONCATENATED MODULE: ./src/components/SortPanel/SortPanel.js

function SortPanel(_ref) {
  var ascEvent = _ref.ascEvent,
    descEvent = _ref.descEvent,
    onReset = _ref.onReset;
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("button", {
    onClick: ascEvent
  }, "asc"), /*#__PURE__*/react.createElement("button", {
    onClick: descEvent
  }, "desc"), /*#__PURE__*/react.createElement("button", {
    onClick: onReset
  }, "reset"));
}
/* harmony default export */ const SortPanel_SortPanel = (SortPanel);
;// CONCATENATED MODULE: ./src/components/SortPanel/index.js

/* harmony default export */ const components_SortPanel = (SortPanel_SortPanel);
;// CONCATENATED MODULE: ./src/routes/List/List.module.scss
// extracted by mini-css-extract-plugin
/* harmony default export */ const List_module = ({"ctrl":"_3Gmz_IK7avcolV_CQ3pgaO","list":"_1j4JDKVoAVmnQpniXBkU7h","card":"Byt_sxZ0BSJLgNdMMvX4g","userInfo":"sAWkKMxBSfvR9VjGosk-X","links":"V4zNmcXhLn-92KVXXiL4S"});
;// CONCATENATED MODULE: ./src/routes/List/List.js
...
function List(_ref) {
  var search = _ref.search,
    ...
    ascEvent = _ref.ascEvent,
    descEvent = _ref.descEvent,
    onReset = _ref.onReset;
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", {
    className: List_module.ctrl
  }, /*#__PURE__*/react.createElement(Filter_Filter, {
    onFilter: onFilter
  }), /*#__PURE__*/react.createElement(components_SortPanel, {
    ascEvent: ascEvent,
    descEvent: descEvent,
    onReset: onReset
    ...
    return /*#__PURE__*/react.createElement("div", {
      key: user.id,
      className: List_module.card
    }, /*#__PURE__*/react.createElement("div", {
      className: List_module.userInfo
    }, /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("span", null, "name:"), " ", user.name), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("span", null, "username:"), " ", user.username), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("span", null, "email:"), " ", user.email)), /*#__PURE__*/react.createElement("div", {
      className: List_module.links
...
var User = /*#__PURE__*/function () {
  ...
  _createClass(User, null, [{
    ...
    key: "fetchUserPosts",
    value: function fetchUserPosts() {
      return http("/posts");
    }
  }, {
    key: "fetchUserAlbums",
    value: function fetchUserAlbums() {
      return http("/albums");
    }
  }]);
  return User;
}();
/* harmony default export */ const services_User = (User);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return services_User.fetchUserList();
          case 3:
...
function useReqContent() {
  ...
  function onFetch() {
    return _onFetch.apply(this, arguments);
  }
  function _onFetch() {
    _onFetch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var ROUTE, _onFetch2, response;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            ROUTE = pathname.split('/')[1];
            _onFetch2 = ROUTE === 'posts' ? services_User.fetchUserPosts : services_User.fetchUserAlbums;
            _context2.next = 5;
            return _onFetch2();
          case 5:
...
function useSort(userList) {
  var _useState9 = (0,react.useState)([]),
    ...
    sortedList = _useState10[0],
    setSortedList = _useState10[1];
  var ascEvent = function ascEvent() {
    var data = _toConsumableArray(userList);
    if (data.length) {
  ...
  var descEvent = function descEvent() {
    var data = _toConsumableArray(userList);
    if (data.length) {
      var res = data.sort(function (a, b) {
...
;// CONCATENATED MODULE: ./src/routes/List/List.container.js
function List_container_slicedToArray(arr, i) { return List_container_arrayWithHoles(arr) || List_container_iterableToArrayLimit(arr, i) || List_container_unsupportedIterableToArray(arr, i) || List_container_nonIterableRest(); }
function List_container_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function List_container_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return List_container_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return List_container_arrayLikeToArray(o, minLen); }
function List_container_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function List_container_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function List_container_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }



function ListContainer() {
  var _useState = (0,react.useState)([]),
    _useState2 = List_container_slicedToArray(_useState, 2),
    userList = _useState2[0],
    setUserList = _useState2[1];
  var _useState3 = (0,react.useState)(''),
    _useState4 = List_container_slicedToArray(_useState3, 2),
    search = _useState4[0],
    setSearch = _useState4[1];
  var _useRequest = useRequest(),
    loading = _useRequest.loading,
    error = _useRequest.error,
    getUsers = _useRequest.getUsers;
  var _useSort = useSort(userList),
    sortedList = _useSort.sortedList,
    ascEvent = _useSort.ascEvent,
    descEvent = _useSort.descEvent,
    reset = _useSort.reset;
  ...
  var filterHandle = function filterHandle(e) {
...
/* harmony default export */ const List_container = (ListContainer);
;// CONCATENATED MODULE: ./src/routes/List/index.js

/* harmony default export */ const routes_List = (List_container);
;// CONCATENATED MODULE: ./src/routes/Content/Content.module.scss
// extracted by mini-css-extract-plugin
/* harmony default export */ const Content_module = ({"back":"_3r51hg5wtPSKkGxJdms35M","post":"_1tcpcJfe1XETIjXJOF5TsA","title":"_11yDgG2g5K8WEUjbWxQdpk","text":"_3kLwb5o-PNsZA2PMfDBwb_"});
;// CONCATENATED MODULE: ./src/routes/Content/Content.js
...
function Content(_ref) {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(Link, {
    className: Content_module.back,
    to: '/'
  }, "Back"), data.map(function (post) {
    return /*#__PURE__*/react.createElement("div", {
      key: post.id,
      className: Content_module.post
    }, /*#__PURE__*/react.createElement("div", {
      className: Content_module.title
    }, post.title), post.body && /*#__PURE__*/react.createElement("div", {
      className: Content_module.text
    }, post.body));
  }));
}
/* harmony default export */ const Content_Content = (Content);
;// CONCATENATED MODULE: ./src/routes/Content/Content.container.js
function Content_container_slicedToArray(arr, i) { return Content_container_arrayWithHoles(arr) || Content_container_iterableToArrayLimit(arr, i) || Content_container_unsupportedIterableToArray(arr, i) || Content_container_nonIterableRest(); }
function Content_container_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function Content_container_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return Content_container_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return Content_container_arrayLikeToArray(o, minLen); }
function Content_container_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function Content_container_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function Content_container_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
function ContentContainer() {
  var _useState = (0,react.useState)([]),
    _useState2 = Content_container_slicedToArray(_useState, 2),
    data = _useState2[0],
    setData = _useState2[1];
  var _useReqContent = useReqContent(),
    loading = _useReqContent.loading,
    error = _useReqContent.error,
    onFetch = _useReqContent.onFetch;
  var _useLocation = dist_useLocation(),
    pathname = _useLocation.pathname;
  (0,react.useEffect)(function () {
    onFetch().then(function (res) {
  ...
  return /*#__PURE__*/react.createElement(Content_Content, {
    data: data
  });
}
/* harmony default export */ const Content_container = (ContentContainer);
;// CONCATENATED MODULE: ./src/routes/Content/index.js

/* harmony default export */ const routes_Content = (Content_container);
;// CONCATENATED MODULE: ./src/components/Header/Template.module.scss
// extracted by mini-css-extract-plugin
/* harmony default export */ const Template_module = ({"wrap":"kmAjtkv57z_xn9TYY4DH-","link":"J0Sp7t_Onloq51DHxumW-"});
...
function Header(props) {
  return /*#__PURE__*/react.createElement("div", {
    className: Template_module.wrap
  }, /*#__PURE__*/react.createElement(Link, {
    className: Template_module.link,
    to: '/'
  }, "Main"));
}
...
;// CONCATENATED MODULE: ./src/components/Template/TEmplate.module.scss
// extracted by mini-css-extract-plugin
/* harmony default export */ const TEmplate_module = ({"body":"_29Qp7rjx9yqn6D4NqrN_jr"});
;// CONCATENATED MODULE: ./src/components/Template/Template.js



function Template(_ref) {
  var Component = _ref.component;
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(components_Header, null), /*#__PURE__*/react.createElement("div", {
    className: TEmplate_module.body
  }, /*#__PURE__*/react.createElement(Component, null)));
}
/* harmony default export */ const Template_Template = (Template);
;// CONCATENATED MODULE: ./src/components/Template/index.js

/* harmony default export */ const components_Template = (Template_Template);
...
var root = (0,client/* createRoot */.s)(app);
root.render( /*#__PURE__*/react.createElement(components_App, null));
})();
